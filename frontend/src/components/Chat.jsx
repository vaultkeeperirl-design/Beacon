      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-neutral-800 bg-neutral-900/80 backdrop-blur-md relative">
        ...
        <div className="flex justify-between items-center mt-3 text-[10px] text-neutral-600 font-medium">
           <div className="relative" ref={emotePickerRef}>
             ...
             {isEmotePickerOpen && (
               <div className="absolute bottom-full mb-2 left-0 bg-neutral-900 border border-neutral-800 rounded-lg p-2 shadow-2xl grid grid-cols-5 gap-1 z-50 animate-in fade-in zoom-in-95 duration-100 w-48">
                 {EMOTES.map(emote => (
                   <button
                     key={emote}
                     type="button"
