...
// ⚡ Performance Optimization: Isolate high-frequency stats
const WalletBalanceStats = memo(function WalletBalanceStats() {
...
// ⚡ Performance Optimization: Isolate high-frequency stats
const WalletBandwidthStats = memo(function WalletBandwidthStats() {
  const stats = useP2PStats();
  return (
