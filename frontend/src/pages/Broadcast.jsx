...
export default function Broadcast() {
  const { setCurrentStreamId, username } = useP2PSettings();
  ...
  return (
    <div className="max-w-7xl mx-auto pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-poppins font-extrabold text-brand tracking-tight">
            Broadcast Studio
          </h1>
          <p className="text-neutral-400 mt-1">
            Manage your stream and network node settings
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <div className="flex-1 md:flex-none px-4 py-2 bg-neutral-900 rounded-lg text-sm font-mono text-neutral-400 border border-neutral-800 flex items-center justify-center gap-2">
            <span className="text-green-500 animate-pulse">●</span> Stream
            Health: Excellent
          </div>
          <button
            onClick={() => {
              ...
              setIsLive(nextLive);
              setCurrentStreamId(nextLive ? username : null);
            }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="aspect-video bg-black rounded-xl overflow-hidden relative group border border-neutral-800 shadow-2xl ring-1 ring-neutral-800">
            ...
            {isCameraOff && (
              <div className="absolute inset-0 flex items-center justify-center text-neutral-700 flex-col gap-4 bg-neutral-950">
                ...
                <span className="font-medium text-lg text-neutral-500 uppercase tracking-widest">
                  Camera Disabled
                </span>
              </div>
            )}
          ...
          <div className="bg-neutral-900/50 rounded-xl p-6 border border-neutral-800">
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  defaultValue="Building the next big thing on Beacon!"
            ...
            <div className="mt-6 flex justify-end">
              <button className="px-6 py-2 bg-neutral-800 hover:bg-neutral-700 text-white rounded-lg transition-colors font-medium border border-neutral-700">
                Update Info
              </button>
            </div>
          </div>
          ...
          <div className="bg-neutral-900/50 rounded-xl p-6 border border-neutral-800">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs font-bold text-beacon-400 border border-beacon-500/30 px-2 py-1 rounded bg-beacon-500/10 uppercase tracking-wide">
                Beta
              </span>
            </div>

            <p className="text-neutral-400 text-sm mb-6">
              Collaboration over competition. Invite guests to your stream and
              automatically split ad revenue and bandwidth credits.
              <span className="text-beacon-400 font-medium">
                {' '}
                No backend deals, just smart contracts.
              </span>
            </p>
            ...
            <div className="space-y-6">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-white flex items-center gap-2">
                            {member.name}
                            {member.isHost && (
                              <span className="text-[10px] bg-beacon-600 px-1.5 py-0.5 rounded text-white uppercase tracking-wide">
                                Host
                              </span>
                            )}
                          </p>
              ...
              <div className="flex items-center gap-2 text-xs text-neutral-500 bg-blue-500/5 p-3 rounded border border-blue-500/10">
                ...
                <p>
                  Smart Contract will automatically distribute payments every 24
                  hours.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div className="bg-neutral-900/50 rounded-xl border border-neutral-800 h-[600px] flex flex-col overflow-hidden relative">
            {isLive ? (
              <Chat streamId={username} isInline />
            ) : (
              <>
                ...
                <div className="flex-1 flex items-center justify-center text-neutral-600 text-sm italic bg-neutral-950/30">
                  <div className="text-center p-8">
                    ...
                    <p className="text-xs text-neutral-700">
                      Messages will appear here once you go live.
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-neutral-900/50 rounded-xl p-6 border border-neutral-800">
            <h3 className="font-poppins font-semibold text-white mb-4 text-sm uppercase tracking-wider text-neutral-400">
              Quick Actions
            </h3>
            <div className="grid grid-cols-2 gap-3">
              <button className="p-3 bg-neutral-800 hover:bg-neutral-700 rounded-lg text-sm font-medium text-white transition-colors border border-neutral-700">
                Raid Channel
              </button>
              <button className="p-3 bg-neutral-800 hover:bg-neutral-700 rounded-lg text-sm font-medium text-white transition-colors border border-neutral-700">
                Start Poll
