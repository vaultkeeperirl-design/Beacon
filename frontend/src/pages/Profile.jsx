                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      min="5"
                      max="80"
                      aria-label="Bandwidth Dedication Percentage"
                  ...
                  <input
                    ...
                    value={formData.bandwidthPercent}
                    onChange={handleBandwidthChange}
                    aria-label="Bandwidth Dedication Range"
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-neutral-900 p-8 rounded-2xl border border-neutral-800">
                <div className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="interests" className="block text-xs font-bold text-neutral-500 uppercase mb-2">Interests (Max 12)</label>
                      ...
                      {formData.interests.map((tag, i) => (
                        <span key={i} className="flex items-center gap-1 px-3 py-1 bg-neutral-800 rounded-full text-xs text-white border border-neutral-700">
                          ...
                          <button
                            ...
                            className="hover:text-beacon-500"
                            aria-label={`Remove interest: ${tag}`}
                            title={`Remove interest: ${tag}`}
                          >
                            <X className="w-3 h-3" />
                          </button>
                        </span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="email" className="block text-xs font-bold text-neutral-500 uppercase mb-2">Email (Optional)</label>
                      <div className="relative">
                    ...
                    <div className="space-y-4">
                      <span className="block text-xs font-bold text-neutral-500 uppercase mb-2">Social Links</span>
                      <div className="relative">
                        <label htmlFor="social-twitch">
                          <Twitch className="absolute left-4 top-2.5 w-4 h-4 text-purple-500 cursor-pointer" />
                        </label>
                        <input
                          id="social-twitch"
                          type="text"
                      ...
                      <div className="relative">
                        <label htmlFor="social-twitter">
                          <Twitter className="absolute left-4 top-2.5 w-4 h-4 text-blue-400 cursor-pointer" />
                        </label>
                        <input
                          id="social-twitter"
                          type="text"
                      ...
                      <div className="relative">
                        <label htmlFor="social-discord">
                          <MessageSquare className="absolute left-4 top-2.5 w-4 h-4 text-indigo-500 cursor-pointer" />
                        </label>
                        <input
                          id="social-discord"
                          type="text"
            ...
            <div className="flex items-center gap-4 pb-2">
               {userProfile.social.twitch && (
                 <a
                   ...
                   target="_blank"
                   rel="noreferrer"
                   className="p-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg text-purple-500 transition-colors"
                   aria-label={`Twitch Profile: ${userProfile.social.twitch}`}
                   title="View Twitch Profile"
                 >
               ...
               {userProfile.social.twitter && (
                 <a
                   ...
                   aria-label={`Twitter Profile: ${userProfile.social.twitter}`}
               ...
               {userProfile.social.discord && (
                 <a
                   href="#"
                   className="p-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg text-indigo-500 transition-colors"
