      ...
      <div className="w-full max-w-md bg-neutral-900 border border-neutral-800 rounded-xl shadow-2xl overflow-hidden">
        <div className="p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-poppins font-extrabold text-brand mb-2">Join Beacon</h1>
            <p className="text-neutral-400">Create your account to start streaming</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="register-password" className="block text-sm font-medium text-neutral-400 mb-2">Password</label>
              <input
            ...
            <div>
              <label htmlFor="register-confirm-password" className="block text-sm font-medium text-neutral-400 mb-2">Confirm Password</label>
              <input
          ...
          <div className="mt-8 text-center text-sm text-neutral-400">
            ...
            <Link to="/login" className="text-beacon-400 hover:text-beacon-300 font-semibold transition-colors">
              Sign in
            </Link>
          </div>
        </div>
